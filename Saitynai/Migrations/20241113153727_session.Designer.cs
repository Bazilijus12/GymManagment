...
namespace Saitynai.Migrations
{
    ...
    [Migration("20241113153727_session")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Saitynai.Auth.Model.GymUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Saitynai.Auth.Model.GymUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Saitynai.Data.Entities.Gym", b =>
                {
                    b.HasOne("Saitynai.Auth.Model.GymUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
